                          ...
                          <div className="p-3 space-y-2">
                            {dayItems.length === 0 ? (
                              ...
                              dayItems.map(item => (
                                <div
                                  key={item.id}
                                  className="flex items-start justify-between gap-3 text-xs p-2 rounded-xl bg-white border border-[#EFEAE2]"
                                >
                                  <div className="flex items-start gap-2.5">
                                    <span className="font-mono font-bold text-[#0EA5A5] w-24 shrink-0">
                                      {item.start_time} - {item.end_time}
                                    </span>
                                    <div>
                                      <p className="font-bold text-[#1F2937]">{item.place_name}</p>
                                      {item.notes && (
                                        <p className="text-[11px] text-[#374151]/70 line-clamp-1">{item.notes}</p>
                                      )}
                                    </div>
                                  </div>
